...
<Warning>
  Contact Search, email and phone lookup, credit history and bucket-detail endpoints, SSE replay, and client-controlled API scopes are not part of the current public API.
</Warning>
