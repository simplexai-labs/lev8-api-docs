...
<Note>
  The API base URL is `https://app.lev8.com`. External API access is being rolled out in stages, and your lev8 contact will enable the entity and contact types available to your workspace.
</Note>
