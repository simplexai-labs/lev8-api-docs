---
title: "Agent Skills"
description: "Install the lev8 API Agent Skill for your agents."
---

Install the lev8 API Agent Skill so your agent can use Entity Search, Contact Search, and the hosted Lev8 MCP endpoint.
...
```text
Install and use the lev8-api Agent Skill.
...
5. Smoke-test with a safe status-only request:
   curl -s -o /dev/null -w "%{http_code}\n" "https://app.lev8.com/v1/credit/balance" -H "x-api-key: $LEV8_API_KEY"
6. For Entity Search, follow create_task, status, then fetch.
7. For MCP, use https://api.lev8.com/mcp with Bearer authentication from LEV8_API_KEY.
