...
curl "https://app.lev8.com/v1/contact-search" \
  ...
  --data '{
    "contact_type": "email",
    "objective": "Find the work email for Maya Chen, VP of Sales at Acme. Owner signals: company website=https://www.acme.com"
  }'
```
...
const response = await fetch("https://app.lev8.com/v1/contact-search", {
  ...
  body: JSON.stringify({
    contact_type: "email",
    objective:
      "Find the work email for Maya Chen, VP of Sales at Acme. Owner signals: company website=https://www.acme.com",
  }),
});
