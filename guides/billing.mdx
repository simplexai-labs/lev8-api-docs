...
The final charge for a completed task is `startup credits + ready_count × per-result credits`. Set `enable_web_search: true` to use the open web startup rate instead of the standard startup rate.
